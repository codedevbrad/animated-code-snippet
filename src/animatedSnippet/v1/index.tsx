...
export default function AnimatedEditorRefactor({ title = 'title not set' , codeSteps }) {
  ...
  return (
    <div className="flex flex-col items-center space-y-4 m-5 bg-gray-200 py-8 p-5 rounded-xl">
          ...
          <div className="bg-black p-4 rounded-2xl w-full shadow-2xl">
            <EditorHeader />
            <CodeDisplay displayedCode={displayedCodeState} previousCode={previousCodeState} />
          </div>
          {currentStep < codeSteps.length && (
